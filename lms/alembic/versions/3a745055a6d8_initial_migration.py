...
Revision ID: 3a745055a6d8
Revises: 
Create Date: 2023-05-16 11:33:22.695913
...
def upgrade() -> None:
    ...
    role_enum = postgresql.ENUM('teacher', 'student', name='role', create_type=True)
    ...
    type_enum = postgresql.ENUM('lesson', 'quiz', 'assignment', name='contenttype', create_type=True)
